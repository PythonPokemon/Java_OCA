...
Erstellung von Java_Anfänger_zum_Profi.Arrays:

int[] arr3[] = new int[8][];

Erstellt ein Array von Java_Anfänger_zum_Profi.Arrays mit 8 Zeilen, aber die Anzahl der Spalten ist noch nicht festgelegt.
Gibt den Speicherort des Java_Anfänger_zum_Profi.Arrays arr3 aus.

int[] arr1 = new int[8];
Erstellt ein eindimensionales Array mit 8 Elementen.
Gibt den Speicherort des Java_Anfänger_zum_Profi.Arrays arr1 aus.

int[][] arr2 = new int[8][8];
Erstellt ein zweidimensionales Array mit 8 Zeilen(untereinander) und 8 Spalten(nebeneinander).
Gibt den Speicherort des Java_Anfänger_zum_Profi.Arrays arr2 aus.
*
* Die Ausgabe besteht aus den Speicherorten der erstellten Java_Anfänger_zum_Profi.Arrays:
* [[I@3cd1a2f1
* [I@2f0e140b
* [[I@7440e464
* */
