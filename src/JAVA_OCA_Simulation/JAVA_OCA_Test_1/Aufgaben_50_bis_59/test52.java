...
* Wenn ein Array direkt mit System.out.println() ausgegeben wird, wird eine Hashcode-Repräsentation des Java_Anfänger_zum_Profi.Arrays ausgegeben, nicht die Elemente selbst.
*
* Variante 3:
...
*
* [I:
* Dieser Teil gibt den Datentyp des Java_Anfänger_zum_Profi.Arrays an. In diesem Fall handelt es sich um ein Array von Ganzzahlen (int).
*
* @:
* Dieses Zeichen trennt den Datentyp des Java_Anfänger_zum_Profi.Arrays vom Hashcode.
*
* 6acbcfc0:
...
package JAVA_OCA_Simulation.JAVA_OCA_Test_1.Aufgaben_50_bis_59;
