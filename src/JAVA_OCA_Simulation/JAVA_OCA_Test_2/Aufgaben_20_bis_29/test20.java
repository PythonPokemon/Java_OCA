...
Da die äußere Schleife alle inneren Java_Anfänger_zum_Profi.Arrays durchläuft und die innere Schleife alle Früchte in jedem inneren Array durchläuft,
...
//----------------------------------------------------------------------------------------------------------------------
/*
Ein zweidimensionales Array wird dadurch erkannt, dass es aus mehreren Java_Anfänger_zum_Profi.Arrays besteht, die wiederum Elemente enthalten.
In Java wird ein zweidimensionales Array durch die Verwendung von doppelten eckigen Klammern [][] definiert.

Hier sind einige Merkmale eines zweidimensionalen Java_Anfänger_zum_Profi.Arrays in Java:
...
Array von Java_Anfänger_zum_Profi.Arrays: Technisch gesehen ist ein zweidimensionales Array ein Array, das aus anderen Java_Anfänger_zum_Profi.Arrays besteht.
Jedes dieser Java_Anfänger_zum_Profi.Arrays in der äußeren Arrayhülle repräsentiert eine Zeile des zweidimensionalen Java_Anfänger_zum_Profi.Arrays.
...
Initialisierung: Die Initialisierung eines zweidimensionalen Java_Anfänger_zum_Profi.Arrays erfolgt durch die Angabe von Werten für jede Zeile und jede Spalte.
