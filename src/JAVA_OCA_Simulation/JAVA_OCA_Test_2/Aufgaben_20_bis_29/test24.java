/*
 Initialisierung des Java_Anfänger_zum_Profi.Arrays:

String[][] arr = { { "7", "6", "5" }, { "4", "3" }, { "2", "1" } };
Das zweidimensionale Array arr wird initialisiert. Es enthält drei Java_Anfänger_zum_Profi.Arrays:
...
Diese Schleife iteriert über die Zeilen des Java_Anfänger_zum_Profi.Arrays arr.
------------------------------------------------------------------------------------------------------------------------
Innere Schleife:
